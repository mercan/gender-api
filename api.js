...
const nameInput = process.argv[2].charAt(0).toLocaleUpperCase() + process.argv[2].substring(1);
...
if (!males.find(nameSearch) && !females.find(nameSearch)) {
  ...
  probability = probability[0] === "0" ? probability.substring(1, 3) : probability.substring(0, 2);
